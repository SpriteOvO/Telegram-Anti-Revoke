...
/*
    ...
    Direct reference to the Qt static library will cause the problem that the DLL file cannot be
    found after injection. So I implemented a simple QString class.
*/
